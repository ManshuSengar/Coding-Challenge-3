    ...
    async createBook(req, res) {
      ...
      async show(req, res) {
       ...
       async update(req, res) {
        try {   
          const book = await bookService.updateBook(req.params.userId,req.body);
          res.send(book);
        } catch (error) {
       ...
       async delete(req, res) {
        try {   
          const book = await bookService.deleteBook(req.params.userId,req.body);
          res.send(book);
        } catch (error) {
          res.status(500).send(error);
        }
       ...
       async userMetric(req, res) {
        try {   
          const book = await bookService.userMetrics1();
          res.send(book);
        } catch (error) {
          res.status(500).send(error);
        }
